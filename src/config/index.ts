...
export const SITE_CONTENT: SiteContent = {
  ...
  projects: [
    ...
    {
      name: "Digital Signal Processing & Audio Recovery Toolkit",
      summary: "Advanced discrete-time filter design in MATLAB, featuring high-order Butterworth IIR filters for FDM audio recovery and image filtering, Savitzky-Golay noise reduction, and notch filtering for selective frequency rejection.",
      linkPreview: "/",
      linkSource: "",
      image: "/Mystery_sound_spectro.jpeg",
    },
    {
      name: "Computational Fourier Optics & SD-OCT Simulation.",
      summary: "A MATLAB-based optical engineering suite featuring a 4f microscope simulation utilizing Zernike phase-contrast filtering alongside a spectral-domain OCT image reconstruction system.",
      linkPreview: "/",
      linkSource: "",
      image: "/Microscopy.jpeg",
    },
    {
      name: "Automated Quantitative Microscopy & Cellular Assays",
      summary: "A MATLAB-based image processing pipeline utilizing 2D Fast Fourier Transforms for automated cell counting alongside time-dependent fluorescence assays analyzing cell viability.",
      linkPreview: "/",
      linkSource: "",
      image: "/RFU.jpeg",
    },
    {
      ...
      summary: "A suite of hands-on hardware engineering projects combining Arduino microcontrollers, circuit wiring, and sensor integration with structural optimization algorithms.",
      linkPreview: "/",
      linkSource: "",
